...
function openFormModifica() {
    document.getElementById("modificaEvento").style.display = "block";
    document.getElementById("page-blur").classList.add("blur-filter");
}

function closeFormModifica() {
    document.getElementById("modificaEvento").style.display = "none";
...
function openForm() {
    document.getElementById("aggiungiEvento").style.display = "block";
    document.getElementById("page-blur").classList.add("blur-filter");
}

function closeForm() {
    document.getElementById("aggiungiEvento").style.display = "none";
    document.getElementById("page-blur").classList.remove("blur-filter");
}
...
function CalendarControl() {
    ...
    const calendarControl = {
        ...
        plotSelectors: function () {
          ...
          <div>-</div>
          <div id="this.year" class="calendar-year-label"></div>
          </div>
