...
function monthFunction() {
    ...
    document.body.innerHTML = document.body.innerHTML.replace('Mese', mm + " " + aaaa);
...
function daysFunction(){
    ...
    set = giorni[firstDay.getDay()];
    //Estrae dalla tabella il mese
    
    if(set === "Domenica"){
        document.body.innerHTML = document.body.innerHTML.replace('gs1', "Domenica");
        document.body.innerHTML = document.body.innerHTML.replace('gs2', "Lunedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs3', "Martedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs4', "Mercoledì");
        document.body.innerHTML = document.body.innerHTML.replace('gs5', "Giovedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs6', "Venerdì");
        document.body.innerHTML = document.body.innerHTML.replace('gs7', "Sabato");
    }
    if(set === "Lunedì"){
        document.body.innerHTML = document.body.innerHTML.replace('gs7', "Domenica");
        document.body.innerHTML = document.body.innerHTML.replace('gs1', "Lunedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs2', "Martedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs3', "Mercoledì");
        document.body.innerHTML = document.body.innerHTML.replace('gs4', "Giovedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs5', "Venerdì");
        document.body.innerHTML = document.body.innerHTML.replace('gs6', "Sabato");
    }
    if(set === "Martedì"){
        document.body.innerHTML = document.body.innerHTML.replace('gs6', "Domenica");
        document.body.innerHTML = document.body.innerHTML.replace('gs7', "Lunedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs1', "Martedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs2', "Mercoledì");
        document.body.innerHTML = document.body.innerHTML.replace('gs3', "Giovedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs4', "Venerdì");
        document.body.innerHTML = document.body.innerHTML.replace('gs5', "Sabato");
    }
    if(set === "Mercoledì"){
        document.body.innerHTML = document.body.innerHTML.replace('gs5', "Domenica");
        document.body.innerHTML = document.body.innerHTML.replace('gs6', "Lunedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs7', "Martedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs1', "Mercoledì");
        document.body.innerHTML = document.body.innerHTML.replace('gs2', "Giovedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs3', "Venerdì");
        document.body.innerHTML = document.body.innerHTML.replace('gs4', "Sabato");
    }
    if(set === "Giovedì"){
        document.body.innerHTML = document.body.innerHTML.replace('gs4', "Domenica");
        document.body.innerHTML = document.body.innerHTML.replace('gs5', "Lunedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs6', "Martedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs7', "Mercoledì");
        document.body.innerHTML = document.body.innerHTML.replace('gs1', "Giovedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs2', "Venerdì");
        document.body.innerHTML = document.body.innerHTML.replace('gs3', "Sabato");
    }
    if(set === "Venerdì"){
        document.body.innerHTML = document.body.innerHTML.replace('gs3', "Domenica");
        document.body.innerHTML = document.body.innerHTML.replace('gs4', "Lunedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs5', "Martedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs6', "Mercoledì");
        document.body.innerHTML = document.body.innerHTML.replace('gs7', "Giovedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs1', "Venerdì");
        document.body.innerHTML = document.body.innerHTML.replace('gs2', "Sabato");
    }
    if(set === "Sabato"){
        document.body.innerHTML = document.body.innerHTML.replace('gs2', "Domenica");
        document.body.innerHTML = document.body.innerHTML.replace('gs3', "Lunedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs4', "Martedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs5', "Mercoledì");
        document.body.innerHTML = document.body.innerHTML.replace('gs6', "Giovedì");
        document.body.innerHTML = document.body.innerHTML.replace('gs7', "Venerdì");
        document.body.innerHTML = document.body.innerHTML.replace('gs1', "Sabato");
    }
...
function daysOfMonth(){
    ...
    if(mm === "Gennaio" || mm === "Marzo" || mm === "Maggio" || mm === "Luglio" || mm === "Agosto" || mm === "Ottobre" || mm === "Dicembre"){
        document.body.innerHTML = document.body.innerHTML.replace('gg1', "29");
        document.body.innerHTML = document.body.innerHTML.replace('gg2', "30");
        document.body.innerHTML = document.body.innerHTML.replace('gg3', "31");
        document.body.innerHTML = document.body.innerHTML.replace('gg4', "1");
        document.body.innerHTML = document.body.innerHTML.replace('gg5', "2");
        document.body.innerHTML = document.body.innerHTML.replace('gg6', "3");
        document.body.innerHTML = document.body.innerHTML.replace('gg7', "4");
    }
    if(mm === "Aprile" || mm === "Giugno" || mm === "Settembre" || mm === "Novembre"){
        document.body.innerHTML = document.body.innerHTML.replace('gg1', "29");
        document.body.innerHTML = document.body.innerHTML.replace('gg2', "30");
        document.body.innerHTML = document.body.innerHTML.replace('gg3', "1");
        document.body.innerHTML = document.body.innerHTML.replace('gg4', "2");
        document.body.innerHTML = document.body.innerHTML.replace('gg5', "3");
        document.body.innerHTML = document.body.innerHTML.replace('gg6', "4");
        document.body.innerHTML = document.body.innerHTML.replace('gg7', "5");
    }
    if(mm === "Febbraio"){
        if(aaaa % 4 === 0){
            document.body.innerHTML = document.body.innerHTML.replace('gg1', "29");
            document.body.innerHTML = document.body.innerHTML.replace('gg2', "1");
            document.body.innerHTML = document.body.innerHTML.replace('gg3', "2");
            document.body.innerHTML = document.body.innerHTML.replace('gg4', "3");
            document.body.innerHTML = document.body.innerHTML.replace('gg5', "4");
            document.body.innerHTML = document.body.innerHTML.replace('gg6', "5");
            document.body.innerHTML = document.body.innerHTML.replace('gg7', "6");
        }else{
            document.body.innerHTML = document.body.innerHTML.replace('gg1', "1");
            document.body.innerHTML = document.body.innerHTML.replace('gg2', "2");
            document.body.innerHTML = document.body.innerHTML.replace('gg3', "3");
            document.body.innerHTML = document.body.innerHTML.reöplace('gg4', "4");
            document.body.innerHTML = document.body.innerHTML.replace('gg5', "5");
            document.body.innerHTML = document.body.innerHTML.replace('gg6', "6");
            document.body.innerHTML = document.body.innerHTML.replace('gg7', "7");
        }
